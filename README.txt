...
## How to run it?
 ...
 - Make sure Microsoft Edge is installed on computer. Open a new Edge tab and go to edge://extensions. Enable 'UiPath Browser Automation'.
 - Now, you can run the project with UiPath.
